...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'export-manager', 'quality-control-officer', 'sales-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Clients', path: '/clients', entity: 'client', service: AccessServiceEnum.PROJECT, icon: FiPhoneCall },
    {
      name: 'Export Orders',
      path: '/export-orders',
      entity: 'export_order',
