...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Surolla  Ganesh`}</title>

        <meta
          name="description"
          content="Experience Global Trade with Surolla Ganesh: Your Trusted Partner in Mango Pulp Export to Other Countries."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1590898714895-88ec87ce59bf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtYW5nbyUyMHB1bHB8ZW58MHx8fHwxNjkwMTIwNzY5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/es/@aperturediaries?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Saif Rahman`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Global Trade with Surolla Ganesh: Your Trusted Partner in Mango Pulp Export to Other Countries.`}
            </Text>
            <Box
