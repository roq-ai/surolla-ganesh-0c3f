...
import { getQualityCheckById } from 'apiSdk/quality-checks';
import { QualityCheckInterface } from 'interfaces/quality-check';

function QualityCheckViewPage() {
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Batch Number" text={data?.batch_number} />

                <FormListItem label="Approval Status" text={data?.approval_status} />
